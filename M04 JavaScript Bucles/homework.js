...
// no se utiliza break porque el return corta la ejecución del switch
      case 2: return "Away"
...
// aca juega el orden en el que ponga if, if else y else.
}
...
function esPrimo(num) {
   ...
   // Tu código:
   if (num <= 1) {return false;} //todo numero menor o igual a 1 no es primo
   for (var i=2; i < num; i++ ) {
// bucle for (ejemplo) --> 5/5 5/4 5/3 5/2 5/1
...
function doWhile(num) {
   ...
   // Tu código:
   var contador = 0 ;
   do {num += 5; contador++; //por cada incremento (1 unidad) del contador, se le suman 5 al num
  } while (contador < 8);
  return (num)
